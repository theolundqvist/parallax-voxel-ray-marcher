...
public:
  ...
  glm::vec3 getPos() { return glm::vec3(mRT[3][0], mRT[3][1], mRT[3][2]); }
  ...
  glm::vec3 getEulerAngles() { return glm::eulerAngles(glm::quat_cast(mRT)); }

  glm::vec3 getUp() { return applyRotation(Direction::up); }
  glm::vec3 getFront() { return applyRotation(Direction::front); }
  glm::vec3 getRight() { return applyRotation(Direction::right); }
  glm::vec3 apply(glm::vec3 vec) { return glm::vec3(mRT * glm::vec4(vec, 1)); }
  glm::vec3 applyRotation(glm::vec3 vec) {
    return glm::vec3(mRT * glm::vec4(vec, 0));
  }
