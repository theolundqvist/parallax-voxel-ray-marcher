...
scene_settings_t scenes[] = {
        ...
        {6, "CA",             camera_positions[CUBE_CAM],         4,  fvta_step_shaded_with_simple_AO, 30, 1,  true},
        {7, "Noise",          camera_positions[CUBE_CAM],         2,  fvta_step_shaded_with_simple_AO, 128, 1,  true},
